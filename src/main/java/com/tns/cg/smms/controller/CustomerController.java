...
import com.tns.cg.smms.service.CustomerService;

@RestController // This annotation specifies class as a controller class, which will accepts
				// requests from rest clients.
public class CustomerController {
	@Autowired // It Injects objects of Customer service implementations into variable
				// "cService".
	...
	public ResponseEntity<?> update(@RequestBody Customer emp, @PathVariable Integer id) {
		...
		try {
			Customer exist = cService.getCustomerById(id);
			cService.save(emp);
