...
import com.tns.cg.smms.service.UserService;
...
//Retrieve operation (retrieving all Users)
	@GetMapping("/Users") // used to retrieve resource from server.
	...
	// Create Operation
	@PostMapping("/Users") // annotation ensures that HTTP POST requests to /Users are mapped to add()
								// method.
	...
	// Update Operation
	@PutMapping("/Users/{id}") // It maps the HTTP PUT requests
